...
static int32_t daysFrom0(int32_t year);

static int32_t daysFrom1970(int32_t year);

static int32_t daysFrom1jan(int32_t year, int32_t month, int32_t day);
...
time_t internalTimegm(std::tm const* t) {
  ...
  const time_t seconds_in_day = time_t(3600 * 24);
