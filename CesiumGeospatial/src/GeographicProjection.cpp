...
GeographicProjection::project(const CesiumGeospatial::GlobeRectangle& rectangle
) const noexcept {
...
Cartographic
GeographicProjection::unproject(const glm::dvec3& projectedCoordinates
) const noexcept {
...
GeographicProjection::unproject(const CesiumGeometry::Rectangle& rectangle
) const noexcept {
