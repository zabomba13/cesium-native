...
WebMercatorProjection::project(const CesiumGeospatial::GlobeRectangle& rectangle
) const noexcept {
...
Cartographic
WebMercatorProjection::unproject(const glm::dvec2& projectedCoordinates
) const noexcept {
...
Cartographic
WebMercatorProjection::unproject(const glm::dvec3& projectedCoordinates
) const noexcept {
...
WebMercatorProjection::unproject(const CesiumGeometry::Rectangle& rectangle
) const noexcept {
...
/*static*/ double
WebMercatorProjection::mercatorAngleToGeodeticLatitude(double mercatorAngle
) noexcept {
...
/*static*/ double
WebMercatorProjection::geodeticLatitudeToMercatorAngle(double latitude
) noexcept {
