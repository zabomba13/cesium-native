...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler.h"
...
ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler::
    ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler(
        const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context),
      _featureIdAttributes(context) {}

void ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionExtMeshGpuInstancingExtFeatureMetadata(
      CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(
              extensionName,
              CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<
          CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata&>(value));
}

CesiumJsonReader::IJsonHandler*
ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler::
    readObjectKeyExtensionExtMeshGpuInstancingExtFeatureMetadata(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata& o) {
  using namespace std::string_literals;
...
BoundsJsonHandler::BoundsJsonHandler(
    const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context), _min(), _max() {}

void BoundsJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::Bounds* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
BoundsJsonHandler::readObjectKey(const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyBounds(
      CesiumGltf::Bounds::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler* BoundsJsonHandler::readObjectKeyBounds(
    const std::string& objectType,
    const std::string_view& str,
    CesiumGltf::Bounds& o) {
  using namespace std::string_literals;
