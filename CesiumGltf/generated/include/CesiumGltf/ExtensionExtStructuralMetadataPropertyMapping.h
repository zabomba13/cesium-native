 ...
 * in attributes.
 */
struct CESIUMGLTF_API ExtensionExtStructuralMetadataPropertyMapping final
    : public CesiumUtility::ExtensibleObject {
  static inline constexpr const char* TypeName =
      "ExtensionExtStructuralMetadataPropertyMapping";

  /**
   * @brief The name of the property mapping, e.g. for display purposes.
   */
