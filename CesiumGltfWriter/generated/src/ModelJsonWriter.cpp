...
void writeJson(
    const CesiumGltf::ExtensionExtStructuralMetadataPropertyMapping& obj,
    CesiumJsonWriter::JsonWriter& jsonWriter,
    const CesiumJsonWriter::ExtensionWriterContext& context);

void writeJson(
    const CesiumGltf::ExtensionExtStructuralMetadataPropertyMappingProperty&
        obj,
    CesiumJsonWriter::JsonWriter& jsonWriter,
    const CesiumJsonWriter::ExtensionWriterContext& context);
...
void writeJson(
  ...
  if (!obj.propertyMappings.empty()) {
    jsonWriter.Key("propertyMappings");
    writeJson(obj.propertyMappings, jsonWriter, context);
  }
...
void ExtensionExtStructuralMetadataPropertyMappingJsonWriter::write(
    const CesiumGltf::ExtensionExtStructuralMetadataPropertyMapping& obj,
    CesiumJsonWriter::JsonWriter& jsonWriter,
    const CesiumJsonWriter::ExtensionWriterContext& context) {
  writeJson(obj, jsonWriter, context);
...
void ExtensionExtStructuralMetadataPropertyMappingPropertyJsonWriter::write(
    const CesiumGltf::ExtensionExtStructuralMetadataPropertyMappingProperty&
        obj,
    CesiumJsonWriter::JsonWriter& jsonWriter,
    const CesiumJsonWriter::ExtensionWriterContext& context) {
