...
struct ExtensionExtStructuralMetadataPropertyMapping;
struct ExtensionExtStructuralMetadataPropertyMappingProperty;
...
struct ExtensionExtStructuralMetadataPropertyMappingJsonWriter {
...
struct ExtensionExtStructuralMetadataPropertyMappingPropertyJsonWriter {
  using ValueType =
