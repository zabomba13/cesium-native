...
struct ExtensionExtImplicitGeometry;
...
struct ExtensionExtImplicitGeometryJsonWriter {
  using ValueType = CesiumGltf::ExtensionExtImplicitGeometry;
...
struct EllipsoidSliceJsonWriter {
...
struct CylinderSliceJsonWriter {
